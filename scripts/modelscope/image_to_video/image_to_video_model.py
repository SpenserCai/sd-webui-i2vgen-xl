...
import modelscope.image_to_video.utils.transforms as data
from modelscope.image_to_video.modules import *
from modelscope.image_to_video.modules import (
    AutoencoderKL, FrozenOpenCLIPVisualEmbedder, Img2VidSDUNet)
from modelscope.image_to_video.utils.config import cfg
from modelscope.image_to_video.utils.diffusion import GaussianDiffusion
from modelscope.image_to_video.utils.seed import setup_seed
from modelscope.image_to_video.utils.shedule import beta_schedule
...
class ImageToVideo():
    ...
    def __init__(self, model_dir):
        ...
        print('Build diffusion with type of GaussianDiffusion')
