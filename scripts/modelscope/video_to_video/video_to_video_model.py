...
import modelscope.video_to_video.utils.transforms as data
from modelscope.video_to_video.modules import *
from modelscope.video_to_video.modules import (
    AutoencoderKL, FrozenOpenCLIPEmbedder, Vid2VidSDUNet,
    get_first_stage_encoding)
from modelscope.video_to_video.utils.config import cfg
from modelscope.video_to_video.utils.diffusion_sdedit import GaussianDiffusion_SDEdit
from modelscope.video_to_video.utils.schedules_sdedit import noise_schedule
from modelscope.video_to_video.utils.seed import setup_seed
...
class VideoToVideo():
    ...
    def __init__(self, model_dir):
        ...
        with open(self.model_dir + '/configuration.json', 'r') as f:
        ...
        print(f'Build encoder with {cfg.embedder.type}')
        ...
        print('Load model {} path {}, with local status {}'.format(
        ...
        print('Build diffusion with type of GaussianDiffusion_SDEdit')
