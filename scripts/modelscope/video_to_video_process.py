...
from modelscope.utils.image import LoadImage
from modelscope.video_to_video.video_to_video_model import VideoToVideo
...
class VideoToVideoPipeline():
    ...
    def postprocess(self, inputs: Dict[str, Any],
        ...
        if status != 0:
            print('Save Video Error with {}'.format(output))
